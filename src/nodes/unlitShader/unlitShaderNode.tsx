...
import plane from '../../../testCube.obj?raw'
...
export const UnlitShaderNode: ComponentType<NodeProps<NodeData>> = ({ id }) => {
    ...
    const [matrix, setMatrix] = useState(new Matrix4(new Vector4(6, 0, -5, 0), new Vector4(1, 0, 0, 0), new Vector4(0,0, 0, 0), new Vector4(0, 0, 0, 0)) as IDataType)
