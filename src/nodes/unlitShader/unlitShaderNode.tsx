...
import plane from '../../../testCube4.obj?raw'
...
export const UnlitShaderNode: ComponentType<NodeProps<NodeData>> = ({ id }) => {
    ...
    const [matrix, setMatrix] = useState(new Matrix4(new Vector4(0, 0, -4, 0), new Vector4(1, 0, 0, 0), new Vector4(0,0, 0, 0), new Vector4(0, 0, 0, 0)) as IDataType)
